        ...
        <div id="ajax_responce_serarchDiv" class="col-md-12">
            ...
            <table id="example2" class="table table-bordered table-hover">
                <thead class="custom_thead">
                    ...
                    <th><?php echo e(__('messages.Available_Qty')); ?></th>
                    ...
                    <tr>
                        ...
                        <td>
                            <?php if($info->category): ?>
                                <a href="<?php echo e(route('categories.index', ['id' => $info->category->id ])); ?>"><?php echo e($info->category->name); ?></a>
                            <?php else: ?>
                                No Category
                            <?php endif; ?>
                        </td>
                        <td><?php echo e($info->available_quantity); ?></td>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u167651649/domains/mutasemjaber.online/public_html/yaman/resources/views/admin/products/index.blade.php ENDPATH**/ ?>