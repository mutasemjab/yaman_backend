...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="col-md-6">
            <div class="form-group">
                <label>  <?php echo e(__('messages.working_hour')); ?> </label>
                <input name="working_hour" id="working_hour" class="form-control" value="<?php echo e(old('working_hour')); ?>">
                <?php $__errorArgs = ['working_hour'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u167651649/domains/mutasemjaber.online/public_html/yaman/resources/views/admin/branches/create.blade.php ENDPATH**/ ?>