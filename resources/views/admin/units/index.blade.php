...
@section('content')
      ...
      <div class="card">
        <div class="card-header">
          ...
          <a href="{{ route('units.create') }}" class="btn btn-sm btn-success" > {{ __('messages.New') }} {{ __('messages.units') }}</a>
        </div>
        <!-- /.card-header -->
        <div class="card-body">
          <div class="row">
            ...
            <table id="example2" class="table table-bordered table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            @can('unit-edit')
                            <a href="{{ route('units.edit', $info->id) }}" class="btn btn-sm btn-primary">{{ __('messages.Edit') }}</a>
                           @endcan
                            @can('unit-delete')
...
@section('script')
<script src="{{ asset('assets/admin/js/unitss.js') }}"></script>
