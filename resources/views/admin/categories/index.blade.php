...
@section('content')
      ...
      <div class="card">
        <div class="card-header">
          ...
          <a href="{{ route('categories.create') }}" class="btn btn-sm btn-success" >   {{ __('messages.New') }} {{ __('messages.categories') }}</a>
        </div>
        <!-- /.card-header -->
        <div class="card-body">
          <div class="row">
            ...
            <table id="example2" class="table table-bordered table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            @can('category-edit')
                            <a href="{{ route('categories.edit', $info->id) }}" class="btn btn-sm btn-primary">{{ __('messages.Edit') }}</a>
                           @endcan
                           @can('category-delete')
...
@section('script')
<script src="{{ asset('assets/admin/js/categoriess.js') }}"></script>
